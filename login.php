...
// Hier wird eine eindeutige ID generiert, und es wird angenommen, dass der Benutzer bereits registriert ist
$existingUser = new User("1", "test@example.com", "passwort123", "Max", "Mustermann");
